...
df = pd.read_csv(p/"datasets"/"20220606_analysis_test_esm1b_classifier.csv", skiprows=1, 
                      usecols=[0,1,2,3,4])
...
# save dataframe
df.to_csv(p/"datasets"/"processed_analysis_test_esm1b_classifier.csv", index=False)
